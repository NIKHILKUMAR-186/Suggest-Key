...
The main seeker application must have exactly four primary sidebar options:
...
There must NOT be a separate Profile sidebar item.
...
Mentor application also follows the four-option structure:
...
Mentor profile, gigs, segments and availability are managed from Settings.

---

# 4.3 ADMIN APP

Admin can have an operational navigation structure appropriate for administration.
...
Admin navigation is not constrained by the four-item seeker/mentor navigation.
...
The existing design system/reference files may be used for visual direction, but product logic must come from this document.

---

# 66. PRIMARY SEEKER FLOW

    ...
    Functions: {
      ...
      create_slot_adjustment: {
        Args: {
          ...
          p_admin_id: string;
          p_action: string;
          p_old_remaining_slots: number;
          p_new_remaining_slots: number;
          p_old_bonus_slots: number;
          p_new_bonus_slots: number;
          p_reason: string;
          p_metadata?: Json;
        };
        Returns: Database["public"]["Tables"]["subscription_slot_adjustments"]["Row"];
      };
